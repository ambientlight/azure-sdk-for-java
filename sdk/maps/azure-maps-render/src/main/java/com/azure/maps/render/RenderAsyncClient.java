...
public final class RenderAsyncClient {
    ...
    public Mono<StreamResponse> getMapTileWithResponse(
        ...
        return this.serviceClient.getMapTileWithResponseAsync(
                format, layer, style, zoom, tileIndex, tileSize, language, view);
    }
    ...
    public Flux<ByteBuffer> getMapTile(
            ...
            String language,
            String view) {
        return this.serviceClient.getMapTileAsync(format, layer, style, zoom, tileIndex, tileSize, language, view);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StreamResponse> getMapStateTileWithResponse(int zoom, String statesetId, TileIndex tileIndex) {
        return this.serviceClient.getMapStateTileWithResponseAsync(zoom, statesetId, tileIndex);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Flux<ByteBuffer> getMapStateTile(int zoom, String statesetId, TileIndex tileIndex) {
        return this.serviceClient.getMapStateTileAsync(zoom, statesetId, tileIndex);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GetCopyrightCaptionResult>> getCopyrightCaptionWithResponse(ResponseFormat format) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GetCopyrightCaptionResult> getCopyrightCaption(ResponseFormat format) {
    ...
    public Mono<StreamResponse> getMapImageryTileWithResponse(
            RasterTileFormat format, MapImageryStyle style, int zoom, TileIndex tileIndex) {
        return this.serviceClient.getMapImageryTileWithResponseAsync(format, style, zoom, tileIndex);
    }
    ...
    public Flux<ByteBuffer> getMapImageryTile(
            RasterTileFormat format, MapImageryStyle style, int zoom, TileIndex tileIndex) {
        return this.serviceClient.getMapImageryTileAsync(format, style, zoom, tileIndex);
    }
    ...
    public Mono<Response<GetCopyrightFromBoundingBoxResult>> getCopyrightFromBoundingBoxWithResponse(
            ResponseFormat format, String mincoordinates, String maxcoordinates, IncludeText text) {
    ...
    public Mono<Response<GetCopyrightForTileResult>> getCopyrightForTileWithResponse(
            ResponseFormat format, int zoom, TileIndex tileIndex, IncludeText text) {
        return this.serviceClient.getCopyrightForTileWithResponseAsync(format, zoom, tileIndex, text);
    }
    ...
    public Mono<GetCopyrightForTileResult> getCopyrightForTile(
            ResponseFormat format, int zoom, TileIndex tileIndex, IncludeText text) {
        return this.serviceClient.getCopyrightForTileAsync(format, zoom, tileIndex, text);
    }
    ...
    public Mono<Response<GetCopyrightForWorldResult>> getCopyrightForWorldWithResponse(
            ResponseFormat format, IncludeText text) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GetCopyrightForWorldResult> getCopyrightForWorld(ResponseFormat format, IncludeText text) {
    ...
    public Mono<StreamResponse> getMapTileV2WithResponse(
        ...
        return this.serviceClient.getMapTileV2WithResponseAsync(
                tilesetId, zoom, tileIndex, timeStamp, tileSize, language, view);
    }
    ...
    public Flux<ByteBuffer> getMapTileV2(
            ...
            String language,
            String view) {
        return this.serviceClient.getMapTileV2Async(tilesetId, zoom, tileIndex, timeStamp, tileSize, language, view);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<MapTilesetResultV2>> getMapTilesetWithResponse(TilesetID tilesetId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MapTilesetResultV2> getMapTileset(TilesetID tilesetId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<MapAttributionResultV2>> getMapAttributionWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MapAttributionResultV2> getMapAttribution(TilesetID tilesetId, int zoom, List<String> bounds) {
