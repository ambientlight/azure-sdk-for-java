...
public final class RenderClient {
    ...
    public InputStream getMapTile(
            ...
            String language,
            String view) {
        return this.serviceClient.getMapTile(format, layer, style, zoom, tileIndex, tileSize, language, view);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public InputStream getMapStateTile(int zoom, String statesetId, TileIndex tileIndex) {
        return this.serviceClient.getMapStateTile(zoom, statesetId, tileIndex);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetCopyrightCaptionResult getCopyrightCaption(ResponseFormat format) {
    ...
    public InputStream getMapImageryTile(
        ...
        return this.serviceClient.getMapImageryTile(format, style, zoom, tileIndex);
    }
    ...
    public GetCopyrightFromBoundingBoxResult getCopyrightFromBoundingBox(
        ...
        return this.serviceClient.getCopyrightFromBoundingBox(format, mincoordinates, maxcoordinates, text);
    }
    ...
    public GetCopyrightForTileResult getCopyrightForTile(
        ...
        return this.serviceClient.getCopyrightForTile(format, zoom, tileIndex, text);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetCopyrightForWorldResult getCopyrightForWorld(ResponseFormat format, IncludeText text) {
        return this.serviceClient.getCopyrightForWorld(format, text);
    }
    ...
    public InputStream getMapTileV2(
            ...
            String language,
            String view) {
        return this.serviceClient.getMapTileV2(tilesetId, zoom, tileIndex, timeStamp, tileSize, language, view);
    }
